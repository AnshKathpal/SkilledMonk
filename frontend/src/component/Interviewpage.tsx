...
const Interviewpage = () => {
  ...
  const getKey = () => {
    ...
    axios
      .get("https://tyaaribackend-production.up.railway.app/chatbot/getkey/1")
      .then((res) => {
        // setIsLoading(false)
  ...
  const startinterview = () => {
    ...
    axios
      .post("https://tyaaribackend-production.up.railway.app/chatbot/chat", obj)
      .then((res) => {
        // setIsLoading(false)
        // toast.success('Interview Started', {
        //     position: "top-center",
