            ...
            messages: [
              {
                ...
                content:
                  "After the techstack is chosen then ask questios related to that tech stack  and questions should be subjective type and not an optional type if the answer is correct proceed to next question and if the answer is wrong tell it is wrong and then proceed to next question",
              },
